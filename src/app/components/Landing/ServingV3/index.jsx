...
const index = () => {
  return (
    <div className={styles.container}>
      <h2 className={styles.lead_text}>How We Serve</h2>
      ...
      <div className={styles.services}>
        ...
        <div className={styles.service}>
          <div className={styles.activity_text}>
            ...
            <p className={styles.activity_content}>
              Honor a loved one with a memorial meal, where our community comes
              together in prayer and remembrance.
            </p>
            <p className={styles.activity_content}>
              Sponsor a meal and share in the tradition of koliva, a sweet dish
              of boiled wheat, while we pray and celebrate the lives of those
              dear to you.
            </p>
            <p className={styles.activity_content}>
        ...
        <div className={styles.service}>
          <div className={styles.activity_text}>
            ...
            <p className={styles.activity_content}>
              ...
              tutoring, led by certified teachers and supported by young
              volunteer tutors. Plus, enjoy fun contests, celebrations, and
              playtime with friends - all while enjoying good food and a
              sense of community!
            </p>
          </div>
        ...
        <div className={styles.service}>
          <div className={styles.activity_text}>
            ...
            <p className={styles.activity_content}>
              Wrap up the evening with a peaceful prayer service, where
              community and reflection come together in a warm and intimate
              setting. Stay and connect with others, as this quiet moment often
              sparks a deeper connection to faith and community.
            </p>
          </div>

          <div className={styles.image_container}>
            <Image
              src={`/placeholders/10.jpg`}
              objectFit="cover"
              layout="responsive"
              height={500}
              width={500}
